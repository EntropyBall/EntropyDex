...
const GIT_URL_POGOASSETS =
    "https://api.github.com/repos/PokeMiners/pogo_assets";
const GIT_URL_IMAGES =
    "https://api.github.com/repositories/243406442/contents/Images";
const GIT_URL_IMAGES_POKEMON =
    "https://api.github.com/repos/PokeMiners/pogo_assets/contents/Images/Pokemon";
const GIT_URL_POGOASSETS_RAW =
    "https://raw.githubusercontent.com/PokeMiners/pogo_assets/master/latest/latest.json";
...
const syncRepo = async (repo) => {
    if (repo !== "game_masters" && repo !== "pogo_assets")
        throw new Error("Wrong repository name. (game_masters or pogo_assets)");
...
const fetchTypeImages = async () => {
    const imgs = await octokit.request(
